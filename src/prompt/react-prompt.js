...
async function reactWorker (directory, template, path, fileName, fileType) {
    try {
        ...
        if (templateObject === undefined || template === null) { ErrorMessage(`Cant find template ${template}. Kindly suggest it so we can provide that template soon! 😉😇`) } else {
...
const ReactHelperMessage = async (starterChoice, fileType) => {
    ...
    case 'httpService': {
        ...
        if (reqDepsInstalled !== undefined) { console.log(chalk.green('axios already installed. 😎 \n')) } else {
    ...
    case 'zustand': {
        ...
        if (reqDepsInstalled !== undefined) { console.log(chalk.green('zustand already installed. 😎 \n')) } else {
    ...
    case 'debounce': {
        ...
        if (dObject.scripts === '') { console.log(chalk.green('react, react-dom already installed. 😎 \n')) } else {
    ...
    case 'formik': {
        ...
        if (dObject.scripts === '') { console.log(chalk.green('formik, yup already installed. 😎 \n')) } else {
            console.log(chalk.green(`Installing ${toBeInstalledDependenciesString}.....`))
            await ExecuteCommand(`npm i ${dObject.scripts}`)
            console.log(chalk.green(`JS-Work-CLI has successfully installed ${toBeInstalledDependenciesString}. 😎 \n`))
        }
    ...
    case 'rhform': {
        ...
        if (dObject.scripts === '') { console.log(chalk.green('react-hook-form, @hookform/resolvers and yup already installed. 😎 \n')) } else {
            console.log(chalk.green(`Installing ${toBeInstalledDependenciesString}.....`))
            await ExecuteCommand(`npm i ${dObject.scripts}`)
            console.log(chalk.green(`JS-Work-CLI has successfully installed ${toBeInstalledDependenciesString}. 😎 \n`))
        }
